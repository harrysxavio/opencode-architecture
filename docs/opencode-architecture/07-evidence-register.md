...
| ID | Hallazgo | Estado | Archivo | Línea/sección | Evidencia | Interpretación | Próxima validación |
|----|----------|--------|---------|---------------|-----------|----------------|-------------------|
| D001 | Manager debe ser el único primary por defecto | DECISIÓN PROPUESTA — NO aprobar hasta validación | — | — | Basado en análisis de capacidad y diseño. Validación runtime P1 no ejecutada. | Resolvería el conflicto de doble orquestador. Pendiente de Test 1. | Ejecutar Test 1 para confirmar agente default antes de decidir |
| D002 | gentle-orchestrator como SDD Pipeline explícito | DECISIÓN PROPUESTA — depende de ADR-001 | — | — | Mantener funcionalidad pero eliminar modo primary | Evita competencia de orquestadores | Aprobar ADR-001 después de validación P1 |
